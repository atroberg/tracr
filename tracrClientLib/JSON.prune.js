	...
	function str(key, holder, depthDecr, arrayMaxLength) {
		...
		case 'object':
			...
			if (Object.prototype.toString.apply(value) === '[object Array]') {
                ...
                value = {
                    type: '{DOM element}',
                    selector: cssSelector.getSelector(value),
                    outerHTML: value.outerHTML
                };
                if (value.outerHTML > OUTERHTML_MAX_LENGTH) {
                    value.outerHTML = value.innerHTML.substring(0, OUTERHTML_MAX_LENGTH);
                }
            }
